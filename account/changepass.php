...
<br>
    <div class="col-lg-4 mx-auto">
        <div class="card mb-5" style='padding:25px;'>
            <p class='text-center' style='font-size:14px;'>Change your password.</p>
            <p id="resetc"></p>
            <form id='changepass' autocomplete='off'>
                <div class="form-group">
                    <label for="phone" style='font-size:14px;'>Enter password</label>
                    <input type="password" class="form-control" id="pass1" placeholder='enter password'>
                    <input type="hidden" class="form-control" id="email" value='<?php echo  isset($_GET['email']) ? $_GET['email'] : null ?>'>

                </div>
                <div class="form-group">
                    <label for="phone" style='font-size:14px;'>Re enter password</label>
